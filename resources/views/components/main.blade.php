            ...
            <div class="container">
                <div class="navbar-brand">
                    <a href="/" class="navbar-item">
                        <strong>MBV<i class="fas fa-volleyball-ball"></i>lley</strong>
                    </a>
                ...
                <div class="navbar-menu" id="navMenu">
                    <div class="navbar-start">
                        ...
                        <a href="/games"
                           class="navbar-item {{ Request::path() === 'games' ? "is-active" : "" }}">
                            Timetable
                        </a>
                        <a href="/results"
                           class="navbar-item {{ Request::path() === 'results' ? "is-active" : "" }}">
                            Results
                        </a>
                        <a href="/rankings"
                           class="navbar-item {{ Request::path() === 'rankings' ? "is-active" : "" }}">
                            Rankings
                        </a>
                        ...
                        <a href="{{ route('playfields.index') }}"
                           class="navbar-item {{ request()->route()->getName() === 'playfields.index' ? "is-active" : "" }}">
                            Playfield
                        </a>
                    </div>
                </div>
